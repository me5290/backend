...
public class Step3 {
    public static void main(String[] args) {
        // 157P
        // 1. 문자열에서 문자 추출 : 문자열.charAt(인덱스);
            // 매개변수 : 추출문자 인덱스 번호 / 리턴값 : 추출된 문자(char)
        ...
        // 3. 문자열 대체 : 문자열.replace();
            // 매개변수 : 변경할 문자열 , 새로운 문자열 / 반환값 : 대체된 새로운 문자열(String)
        ...
        // 4. 문자열 잘라내기 : 문자열.subString();
            // 매개변수 : (1)시작인덱스 (2) 시작인덱스 , 끝인덱스 / 반환값 : 잘라낸 문자열 추출(String)
        ...
        String subString = subject.substring(location); // ---> 3번 인덱스부터 마지막인덱스까지 자르기 ---> 프로그래밍
